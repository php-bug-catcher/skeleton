 ...
 *     no_bug_funny_messages?: list<scalar|Param|null>,
 * }
 * @psalm-type PersistentStateConfig = array{
 *     preference?: array{
 *         managers?: array<string, array{ // Default: []
 *             storage?: scalar|Param|null, // The service ID of the storage backend to use (e.g. "@app.storage.doctrine").
 *         }>,
 *     },
 *     selection?: array{
 *         managers?: array<string, array{ // Default: []
